  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-50 hidden h-svh w-(--sidebar-width) transition-transform duration-200 ease-linear md:flex",
      ...
      >
        <div
          ...
          className="bg-sidebar flex h-full w-full flex-col shadow-lg"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "fixed top-4 left-4 z-40 size-10",
