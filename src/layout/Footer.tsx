const Footer = () => {
  return (
    <div className="space-y-4 pt-10 md:space-y-0 bg-[#060a0c] text-white px-4">
      <a href="https://hufs.ac.kr" target="_blank" rel="noopener noreferrer">
        <img
          className="w-50 h-10"
      ...
      <div className="flex flex-col items-end pb-4 space-y-2 text-xs text-right">
        ...
        <div className="flex space-x-2">
          ...
          <div>경기도 용인시 처인구 모현읍 외대로 81 공학관 205호</div>
        </div>
        {/* <div
