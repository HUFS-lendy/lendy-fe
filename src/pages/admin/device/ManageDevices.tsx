...
type FormState = { infoBadgeLabel: string; infoSummary: string; recommendedFor: string; specifications: string; referenceUrl: string; imageUrls: string[] };
...
const ManageDevices = () => {
  ...
  const [form, setForm] = useState<FormState>({ infoBadgeLabel: "", infoSummary: "", recommendedFor: "", specifications: "", referenceUrl: "", imageUrls: [] });
  ...
  useEffect(() => { if (selected) { const info = infoFor(selected); setForm({ infoBadgeLabel: selected.infoBadgeLabel || selected.categoryName, infoSummary: info.summary, recommendedFor: info.recommendedFor, specifications: info.specifications, referenceUrl: info.referenceUrl, imageUrls: info.imageUrls }); } }, [selected]);
