...
type FormState = { infoSummary: string; recommendedFor: string; specifications: string; referenceUrl: string; imageUrls: string[] };
...
const ManageDevices = () => {
  ...
  const [form, setForm] = useState<FormState>({ infoSummary: "", recommendedFor: "", specifications: "", referenceUrl: "", imageUrls: [] });
  ...
  useEffect(() => { if (selected) { const info = infoFor(selected); setForm({ infoSummary: info.summary, recommendedFor: info.recommendedFor, specifications: info.specifications, referenceUrl: info.referenceUrl, imageUrls: info.imageUrls }); } }, [selected]);
